...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    ...
    const savedUserResponse = await fetch(`${process.env.REACT_APP_BASE_API_URL}/auth/register`, {
      method: 'POST',
      body: formData,
    });
  ...
  const login = async (values, onSubmitProps) => {
    const loggedInResponse = await fetch(`${process.env.REACT_APP_BASE_API_URL}/auth/login`, {
      method: 'POST',
